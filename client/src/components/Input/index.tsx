  ...
  return (
    <div className={clsx('relative flex w-full items-center', className)}>
      ...
      <input
        ...
        type={localType}
        className={clsx(
          'block flex-1 rounded-md border-0 bg-transparent py-1.5 shadow-sm ring-1 transition duration-200 placeholder:text-gray-400 focus:ring-2 dark:placeholder:text-gray-500 dark:focus:ring-blue-700 dark:focus:placeholder:text-gray-600 sm:text-sm sm:leading-6',
          {
            'ring-red-600 placeholder:text-red-500 focus:ring-red-600 dark:ring-red-600 dark:placeholder:text-red-500 dark:focus:ring-red-600':
              !!error,
            'ring-slate-200 hover:ring-blue-700 focus:ring-blue-700 dark:ring-slate-600 dark:hover:ring-blue-700':
              !error,
            'pr-[44px]': !!RightIcon,
            // 'pl-[44px]': !!LeftIcon,
          },
      ...
      <div
        className={clsx(
          'pointer-events-none absolute right-0 top-full z-40 mr-0.5 mt-[7px] w-fit max-w-[91%] origin-[85%_0%] rounded-md bg-red-600 text-right transition duration-[380ms]',
          {
