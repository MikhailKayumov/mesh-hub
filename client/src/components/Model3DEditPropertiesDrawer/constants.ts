import zod from 'zod';
import { CategoryRequest, CategoryResponse, Model3DResponseDto, Model3DUpdateRequestDto } from '@/api/dto.ts';
import { Model3DPropertiesForm } from '@/components/Model3DEditPropertiesDrawer/model.ts';
import { MAX_MODEL_3D_CATEGORIES_LENGTH, MAX_MODEL_3D_NAME_LENGTH, ValidationErrorMessages } from '@/constants';
