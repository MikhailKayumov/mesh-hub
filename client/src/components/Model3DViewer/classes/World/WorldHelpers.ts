import { AxesHelper, Box3Helper, ColorRepresentation, GridHelper, Mesh } from 'three';

export class WorldHelpers {
  private static AXIS_GRID_HELPER_LAYER = 10;
  private static GROUND_HELPER_LAYER = 11;
  private static SCENEBB_HELPER_LAYER = 12;
